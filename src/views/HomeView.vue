...
<template>
  <div class="gratis">
    ...
    <div class="gratis2">
      <h1>divirta-se</h1>
      <h2>Teste gratuito de 15 dias</h2>
      <a href="#">Assine aqui</a>
      <h3>*Para continuar depois do teste o pagamento será solicitado</h3>
    </div>
  </div>

  <div>
    <h1 class="titulo-planos">Escolha seu plano Multitelas</h1>
  </div>
  ...
  <div class="titulo-antecipado">
    <h3>
      Necessário pagamento antecipado. Economia baseada no preço do plano multitelas anual comparado
      ao preço do plano multitelas mensal durante 12 meses,
    </h3>
...
.link:hover {
  color: rgb(156, 105, 250);
  transition: 0.5s;
}
.card {
  background-image: linear-gradient(rgb(1, 3, 24), rgb(3, 10, 97) 150%);
  color: white;
  font-family: 'Anek Malayalam', sans-serif;
  font-family: 'IBM Plex Sans', sans-serif;
  font-family: 'Lexend', sans-serif;
...
.col {
  ...
  align-items: center;
  text-align: center;
  background-image: linear-gradient(rgb(3, 10, 97), rgb(2, 4, 32) 70%);
  margin-left: 5%;
  margin-right: 5%;
  margin-top: 5%;
  border-radius: 10px;
...
.col button {
  margin-top: 90px;
  border-radius: 20px;
  background-image: linear-gradient(45deg, rgb(113, 36, 255) 0, 0001%, rgb(7, 12, 85));
  border-color: rgb(35, 45, 175);
  color: white;
  font-size: 25px;
  width: 90%;
